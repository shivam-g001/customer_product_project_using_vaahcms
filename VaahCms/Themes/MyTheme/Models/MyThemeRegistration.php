<?php namespace VaahCms\Themes\MyTheme\Models;

use Illuminate\Http\Request;
use Illuminate\Support\Facades\Crypt;
use Illuminate\Support\Str;
use VaahCms\Themes\MyTheme\Notifications\ActivationLinkNotification;
use WebReinvent\VaahCms\Entities\Registration;
use WebReinvent\VaahCms\Entities\User;

class MyThemeRegistration extends Registration
{
...
//dd($item);
	...
	public static function activateRegistration($request)
    {
        ...
        // Create User
        $user = MyThemeUser::createUser($user_request);
...
//
        ...
        $response['status'] = 'success';
        $response['data']['redirect_url'] = route('vh.frontend.mytheme.signin');
