...
class ProductsController extends Controller
{
    ...
    public function getAssets(Request $request)
    {
        ...
        try{
            ...
            $data['taxonomy_training_data'] = Product::getTaxonomyTraining();
            $data['country_data'] = Product::getTaxonomyCountry();
            $data['state_data'] = Product::getTaxonomyState();

            $data['blog'] = Product::getBlogData();
