...
class BackendController extends Controller
{
    ...
    public function index(Request $request)
    {
         ...
         */
        /*
        $permission_slug = 'has-access-customerproject';
        ...
        */
        ...
        return view('customerproject::backend.pages.app');
    ...
    public function getAssets(Request $request)
    {
        ...
        */
        ...
        $data['module'] = [
            'name' => config('customerproject.name'),
            'version' => config('settings.global.customerproject_version')??config('customerproject.version'),
            'is_dev' => config('customerproject.is_dev'),
        ];
