...
use VaahCms\Modules\CustomerProject\Models\Product;
...
class ProductsController extends Controller
{
    ...
    public function getAssets(Request $request)
    {
        ...
        try{
            ...
            $data['customer_data'] = Product::getCustomersData();
            $data['blog_data'] = Product::getBlogData();
            $data['actions'] = [];
    ...
    public function searchCustomerNames(Request $request): array
    {
        try{
            return Product::autoCompleteSearch($request);
        }catch (\Exception $e){
            $response = [];
            $response['success'] = false;
            if(env('APP_DEBUG')){
