...
use VaahCms\Modules\CustomerProject\Models\User;
...
class UsersController extends Controller
{
    ...
    {
//        if (!Auth::user()->hasPermission('customerproject-can-update-users')) {
//            $response['success'] = false;
//            $response['errors'][] = trans("vaahcms::messages.permission_denied");
//
//            return response()->json($response);
//        }
//      // Import Role class at the top
...
//                $notification, $user, $inputs,'medium'
//            );
//        }
//
...
//    {
//        $user = \VaahCms\Modules\CustomerProject\Models\User::find($request->input('user_id'));
////        dd($user);
//        $notification = \WebReinvent\VaahCms\Models\Notification::where('slug', "send-welcome-email")->first();
//
//        if ($notification) {
...
//                "user_id" => $user->id,
//                "notification_id" => $notification->id,
//                "custom_url" => $request->input('custom_url', 'https://vaah.dev'),
//            ];
//            dd($inputs);
//
...
////                dd($notification);
//                $response['success'] = true;
//                $response['data'] = $data; // Add data if needed
//                $response['messages'] = ["Action was successful"];
//
//            } else {
//                $response['success'] = false;
//                $response['errors'][] = 'Notification or user not found.';
//            }
//        } catch (\Exception $e) {
//            $response = [];
//            $response['success'] = false;
...
//            $user = new User();
//            $notify = $user->notify($id);

            $id = $request->input('user_id');
            $notify = (new \VaahCms\Modules\CustomerProject\Models\User)->notify($id);
