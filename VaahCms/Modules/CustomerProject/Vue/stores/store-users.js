...
let model_namespace = 'VaahCms\\Modules\\CustomerProject\\Models\\User';


let base_url = document.getElementsByTagName('base')[0].getAttribute("href");
let ajax_url = base_url + "/customerproject/users";
...
export const useUserStore = defineStore({
    ...
    actions: {
        ...
        async getNotificationViaEmail(id) {
            let query = {
                user_id: id
            };
            const options = {
            ...
            await vaah().ajax(
                this.ajax_url+'/send-email-notification/notify',
