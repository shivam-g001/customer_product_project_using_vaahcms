    ...
    <div v-if="store.list && store.assets">
        ...
        >
            ...
            <Column  v-if="store.isViewLarge()"
                     header="Avatar">
                <template #body="prop">
                    <Avatar :image=" prop.data.avatar" class="absolute" shape="circle" />
                </template>
            </Column>
            ...
            <Column  header="Notify" :sortable="true">
                <template #body="prop">
                    <Button class="click_customer " @click="store.getNotificationViaEmail(prop.data.id)" severity="success"  rounded >Notify</Button>
            ...
            <Column field="roles"
                    header="Roles"
                    :disabled="store.assets.permission.includes('can-update-users')"
                    >
                <template #body="prop">
