...
<!--                    {{prop.data.name}}-->
             ...
             <Column field="customers.slug" header="Owned By"
                     :sortable="true" value="">
             </Column>

             <Column field="blog.name" header="Category" :sortable="true" v-if="store.isViewLarge()">
                 <template #body="prop">
                    <span v-if="prop.data.blog.length > 0">
                        <Tag severity="success">{{ prop.data.blog[0].name }}</Tag>
                        <span v-if="prop.data.blog.length > 1">, ...</span>
                    </span>
                 </template>
             </Column>
