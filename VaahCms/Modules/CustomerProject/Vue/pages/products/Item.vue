            ...
            <div class="mt-2" v-if="store.item">
                ...
                <table class="p-datatable-table">
                    ...
                    <template v-for="(value, column) in store.item ">
                        ...
                        || column==='customer_id'|| column==='customers' ||column==='blog'||column==='blog_id'
                        ||column==='customer_slug'||column==='description'">
                        </template>
                        ...
                        <template v-else-if="column === 'slug'  ">
                            <VhViewRow :label="column"
                                       ...
                                       type="slug"
                            />
                            <VhViewRow label="Customer"
                                       :value=store.item.customers
                                       type="name"

                            />
                            <VhViewRow label="Category"
                                       :value=store.item.blog
                                       type="blog"
                            />
